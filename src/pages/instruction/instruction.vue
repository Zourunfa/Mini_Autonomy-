<template>
  <div class="instruction">
    ...
    <!-- <p class="content tip"><label class="point">◉</label> 。</br>比如分数越多就会越幸运；凑足3个100分，就能有贵人相助等等。虽然听起来比较幼稚，对我自己而言这种心理暗示对生活还是很有积极意义的~</p>
    <p class="content tip"><label class="point">◉</label> </br>比如凑足300分，奖励自己一顿海底捞；够了500分，奖励自己旅游基金1000元等。虽然都是从自己身上薅下的肉，但是生活更有仪式感了~</p> -->
